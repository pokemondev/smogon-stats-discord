...
const formatCases: FormatCase[] = [
  {
    args: [],
    expected: { generation: 'gen9', tier: 'ou' }
  },
  {
    args: [ 'pikachu' ],
    expected: { generation: 'gen9', tier: 'ou' }
  ...
  {
    args: [ 'gen8', 'uu' ],
    expected: { generation: 'gen8', tier: 'uu' }
  },
  {
    args: [ 'uu', 'gen6' ],
    expected: { generation: 'gen6', tier: 'uu' }
  },
  {
    args: [ 'charizard', 'gen7', 'uber' ],
    expected: { generation: 'gen7', tier: 'ubers' }
  },
  {
    args: [ 'vgc' ],
    expected: { generation: 'gen9', tier: 'vgc2026regf' }
  },
  {
    args: [ 'gen8', 'vgc' ],
    expected: { generation: 'gen8', tier: 'vgc2021' }
  },
  {
    args: [ 'vgc', '2021' ],
    expected: { generation: 'gen8', tier: 'vgc2021' }
  ...
  },
  {
    ...
    expected: { generation: 'gen9', tier: 'vgc2026regi' }
  },
  {
    args: [ 'vgc', '2026', 'regi' ],
    expected: { generation: 'gen9', tier: 'vgc2026regi' }
